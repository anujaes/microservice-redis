...
const jobHandlers: QueueConfig[] = [
    {
        queueName: process.env.SERVER_ONE_QUEUE_X!,
        jobHandlers: {
            [process.env.QUEUE_X_JOB_ONE!]: queueOneJobOne,
            // [process.env.QUEUE_X_JOB_TWO!]: queueOneJobTwo,
        }
    },
    {
        queueName: process.env.SERVER_ONE_QUEUE_Y!,
        jobHandlers: {
            [process.env.QUEUE_Y_JOB_ONE!]: queueTwoJobOne,
            // [process.env.QUEUE_Y_JOB_TWO!]: queueTwoJobTwo
        }
    }
];
